...
class Loop {
	...
	public static void main(String[] args) {
		...
		while (programRunning) {
			...
			System.out.println("2. Print prime numbers within range");
			System.out.println("3. Digit Display");
			System.out.println("4. Digit Sum");
			System.out.println("5. Elapsed time calculator");
			System.out.println("6. Monogram generator");
			System.out.println("7. Vowel counter");
